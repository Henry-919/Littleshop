...
export function Inventory({ store, storeId }: { store: ReturnType<typeof useStore>; storeId?: string }) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      {/* 顶部工具栏 */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-3 w-full lg:w-auto">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-10 pr-4 py-2 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-emerald-500 w-full sm:w-52 lg:w-48 text-sm transition-all"
            />
          </div>

          <div className="flex flex-wrap items-center gap-2">
            <span className="w-full sm:w-auto text-xs text-slate-500">入库时间</span>
            <input
              type="date"
              value={inboundStart}
